...
internal class HostListenerBackgroundService : BackgroundService
{
    private readonly IServiceHost _host;
    private readonly ServiceAddress _serviceAddress;
    private readonly ILogger<HostListenerBackgroundService> _logger;

    public HostListenerBackgroundService(
        IServiceHost host,
        IOptions<ServiceAddress> serviceAddressOptions,
        ILogger<HostListenerBackgroundService> logger)
    {
        _host = host;
