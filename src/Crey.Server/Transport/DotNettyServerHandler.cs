...
internal class DotNettyServerHandler : ChannelHandlerAdapter
{
    private readonly ILogger<DotNettyServerHandler> _logger;
    private readonly Action<IChannelHandlerContext, MessageInvoke> _readAction;

    public DotNettyServerHandler(Action<IChannelHandlerContext, MessageInvoke> readAction, ILoggerFactory loggerFactory)
    {
        _readAction = readAction;
        _logger = loggerFactory.CreateLogger<DotNettyServerHandler>();
    }
